...
<html lang="en"> 
<head>
    <title>Ajouter un Hadith - Daaray-Digital</title>
                    ...
                    <form action="{{ route('hadiths.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('content') is-invalid @enderror" 
                                              ...
                                              placeholder="Entrez le contenu du hadith">{{old('content')}}</textarea>
                                    @error('content')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    <label for="categorie" class="form-label">
                                        <i class="fas fa-heading text-primary me-2"></i>Categorie du Hadith
                                    </label>
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn app-btn-primary">
                                <i class="fas fa-save me-2"></i>Enregistrer le Hadith
                            </button>
