        ...
        <div class="container-xl">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">Gérez et organisez les différents types de propriétés de votre système</p>
                </div>
                <div class="quick-actions">
                   
                    
                    <a href="{{ route('type_properties.create') }}" class="btn app-btn-primary">
                    ...
                    <div class="app-card stat-card primary shadow-sm h-100">
                        <div class="app-card-body p-3 p-lg-4">
                            <div class="row align-items-center">
                                <div class="col">
                                    <div class="app-card-stat-title text-white-50">Total Types</div>
                                    <div class="app-card-stat-value text-white">{{ $typeProperties->count() }}</div>
                ...
                <div class="col-6 col-lg-3">
                    <div class="app-card stat-card success shadow-sm h-100">
                        <div class="app-card-body p-3 p-lg-4">
                            <div class="row align-items-center">
                                <div class="col">
                                    <div class="app-card-stat-title text-white-50">Types Actifs</div>
                                    <div class="app-card-stat-value text-white">{{ $typeProperties->where('is_active', true)->count() }}</div>
                                    <div class="text-white-50 small mt-1">
                                        <i class="fas fa-check-circle me-1"></i>Fonctionnels
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <div class="stat-icon">
                ...
                <div class="col-6 col-lg-3">
                    <div class="app-card stat-card info shadow-sm h-100">
                        <div class="app-card-body p-3 p-lg-4">
                            <div class="row align-items-center">
                                <div class="col">
                                    <div class="app-card-stat-title text-white-50">Avec Icônes</div>
                                    <div class="app-card-stat-value text-white">{{ $typeProperties->whereNotNull('icon')->count() }}</div>
                                    <div class="text-white-50 small mt-1">
                                        <i class="fas fa-icons me-1"></i>Personnalisés
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <div class="stat-icon">
                ...
                <div class="col-6 col-lg-3">
                    <div class="app-card stat-card warning shadow-sm h-100">
                        <div class="app-card-body p-3 p-lg-4">
                            <div class="row align-items-center">
                                <div class="col">
                                    <div class="app-card-stat-title text-white-50">Types Inactifs</div>
                                    <div class="app-card-stat-value text-white">{{ $typeProperties->where('is_active', false)->count() }}</div>
                                    <div class="text-white-50 small mt-1">
                ...
                <div class="table-container">
                    <div class="table-actions-header">
                        ...
                        <div class="table-info">
                            <span id="totalCount">{{ $typeProperties->count() }}</span> type(s) au total
                        </div>
                    </div>
                        ...
                        <table class="table app-table-hover mb-0 text-left" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="cell" data-sort="name">
                                        <i class="fas fa-tag text-primary me-2"></i>Nom
                                        <i class="fas fa-sort sort-indicator"></i>
                                    </th>
                                    <th class="cell" data-sort="description">
                                        <i class="fas fa-align-left text-primary me-2"></i>Description
                                        <i class="fas fa-sort sort-indicator"></i>
                                    </th>
                                    <th class="cell text-center">
                                        <i class="fas fa-icons text-primary me-2"></i>Icône
                                    </th>
                                    <th class="cell text-center" data-sort="is_active">
                                        <i class="fas fa-toggle-on text-primary me-2"></i>Statut
                                        <i class="fas fa-sort sort-indicator"></i>
                                    </th>
                            ...
                            <tbody id="tableBody">
                                @forelse ($typeProperties as $type)
                                <tr data-id="{{ $type->id }}">
                                    <td>
                                        <div class="form-check">
                                            <input class="form-check-input row-checkbox" type="checkbox" value="{{ $type->id }}">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            @if ($type->icon)
                                                <div class="table-icon me-3" style="background-color: {{ $type->color ?? '#f8f9fa' }}20; color: {{ $type->color ?? '#495057' }}">
                                                    <i class="{{ $type->icon }}"></i>
                                                </div>
                                            @endif
                                            <div>
                                                ...
                                                @if($type->slug)
                                                    <div class="text-muted small">{{ $type->slug }}</div>
                                                @endif
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="description-cell">
                                            ...
                                            @if(strlen($type->description) > 100)
                                                <button class="btn btn-link btn-sm p-0 ms-1" onclick="toggleDescription(this)">
                                                    <i class="fas fa-expand-alt"></i>
                                                </button>
                                                <div class="full-description d-none">{{ $type->description }}</div>
                                            @endif
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        @if ($type->icon)
                                            <div class="table-icon mx-auto" style="background-color: {{ $type->color ?? '#f8f9fa' }}20; color: {{ $type->color ?? '#495057' }}">
                                                <i class="{{ $type->icon }}"></i>
                                            </div>
                                            <div class="text-muted small mt-1">{{ $type->icon }}</div>
                                        @else
                                    ...
                                    <td class="text-center">
                                        <span class="status-badge {{ $type->is_active ? 'status-active' : 'status-inactive' }}">
                                            <i class="fas fa-{{ $type->is_active ? 'check-circle' : 'times-circle' }}"></i>
                                    ...
                                    <td class="text-center">
                                        <div class="action-buttons">
                                            ...
                                            <a href="{{ route('type_properties.edit', $type) }}" class="btn-action btn-edit" title="Modifier">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="{{ route('type_properties.destroy', $type) }}" method="POST" class="inline">
                                                @csrf @method('DELETE')
                                                <button type="submit" class="btn-action btn-delete" title="Supprimer"  onclick="return confirm('Supprimer ?')"> <i class="fas fa-trash"></i></button>
                                            </form>
                                ...
                                <tr>
                                    <td colspan="7">
                                        <div class="empty-state">
                                            ...
                                            <h5>Aucun type de propriété trouvé</h5>
                                            <p class="text-muted">Commencez par créer votre premier type de propriété.</p>
                                            <a href="{{ route('type_properties.create') }}" class="btn app-btn-primary">
                                                <i class="fas fa-plus me-2"></i>Créer un type de propriété
                                            </a>
                                        </div>
                                    </td>
                                </tr>
                    ...
                    <div class="pagination-wrapper">
                        <div class="text-muted">
                            Affichage de {{ $typeProperties->count() }} résultat(s)
                        </div>
                        <div>
