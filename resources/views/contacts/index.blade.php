        ...
        <div class="app-card stat-card primary shadow-sm h-100">
            <div class="app-card-body p-3 p-lg-4">
                <div class="row align-items-center">
                    <div class="col">
                        <div class="app-card-stat-title text-white-50">Total Contacts</div>
                        <div class="app-card-stat-value text-white">{{ $contacts->count() }}</div>
                        <div class="text-white-50 small mt-1">
                            <i class="fas fa-user-plus me-1"></i>+{{ $contacts->where('created_at', '>=', now()->startOfMonth())->count() }} ce mois
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="stat-icon">
    ...
    <div class="col-6 col-lg-3">
        <div class="app-card stat-card success shadow-sm h-100">
            <div class="app-card-body p-3 p-lg-4">
                <div class="row align-items-center">
                    <div class="col">
                        <div class="app-card-stat-title text-white-50">Demandes de Vente</div>
                        <div class="app-card-stat-value text-white">{{ $contacts->where('type_demande', 'vente')->count() }}</div>
                        <div class="text-white-50 small mt-1">
                            <i class="fas fa-home me-1"></i>Demandes directes
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="stat-icon">
            ...
            <div class="app-card-body p-3 p-lg-4">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <div class="app-card-stat-value text-white">{{ $contacts->where('status', 'en_attente')->count() }}</div>
                        <div class="text-white-50 small mt-1">
    ...
    <div class="col-6 col-lg-3">
        <div class="app-card stat-card warning shadow-sm h-100">
            <div class="app-card-body p-3 p-lg-4">
                <div class="row align-items-center">
                    <div class="col">
                        <div class="app-card-stat-title text-white-50">Clôturés</div>
                        <div class="app-card-stat-value text-white">{{ $contacts->where('status', 'cloturee')->count() }}</div>
                        <div class="text-white-50 small mt-1">
    ...
    <div class="table-container">
        <div class="table-actions-header">
            ...
            <div class="table-info">
                <span id="totalCount">{{ $contacts->count() }}</span> contact(s) au total
            </div>
        </div>
            ...
            <table class="table app-table-hover mb-0 text-left" id="dataTable">
                <thead>
                    <tr>
                        ...
                        <th class="cell"><i class="fas fa-user text-primary me-2"></i>Nom</th>
                        ...
                        <th class="cell"><i class="fas fa-question-circle text-primary me-2"></i>Type</th>
                        <th class="cell"><i class="fas fa-comment-dots text-primary me-2"></i>Message</th>
                        <th class="cell"><i class="fas fa-tag text-primary me-2"></i>Statut</th>
                        <th class="cell text-center"><i class="fas fa-calendar text-primary me-2"></i>Créé le</th>
                        <th class="cell text-center"><i class="fas fa-cogs text-primary me-2"></i>Actions</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse ($contacts as $contact)
                        <tr data-id="{{ $contact->id }}" class="fade-in">
                            <td class="cell">
                                <div class="form-check">
                                    <input class="form-check-input bulk-checkbox" type="checkbox" value="{{ $contact->id }}">
                                </div>
                            </td>
                            <td class="cell">{{ $contact->id }}</td>
                           ...
                           <td class="cell">
                            ...
                            <td class="cell text-center">
                                ...
                                <form action="{{ route('contacts.destroy', $contact) }}" method="POST" class="d-inline-block">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger" onclick="return confirm('Supprimer ce contact ?')">
                    ...
                    @empty
                        <tr>
                            <td colspan="10" class="text-center empty-state">
                                <i class="fas fa-user-times empty-state-icon"></i>
                                <p class="mt-3">Aucun contact trouvé.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
