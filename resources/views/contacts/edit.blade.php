        ...
        <div class="container-xl">
            ...
            <div class="app-card app-card-orders-table shadow-sm mb-5">
                ...
                <div class="app-card-body p-4">
                    <form action="{{ $isEdit ? route('type_properties.update', $typeProperty) : route('type_properties.store') }}" method="POST" id="propertyTypeForm">
                        @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input 
                                            ...
                                            id="name" 
                                            name="name" 
                                            placeholder="Nom du type de propriété"
                                            value="{{ old('name', $typeProperty->name ?? '') }}" 
                                            required 
                                        />
                                        <label for="name">
                                            <i class="fas fa-tag text-primary me-2"></i>Nom du type de propriété *
                                        </label>
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input 
                                            ...
                                            value="{{ old('slug', $typeProperty->slug ?? '') }}" 
                                        />
                                        <label for="slug">
                                            <i class="fas fa-link text-primary me-2"></i>Identifiant unique (slug)
                                        </label>
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea 
                                            ...
                                            style="height: 120px"
                                        >{{ old('description', $typeProperty->description ?? '') }}</textarea>
                        ...
                        <div class="form-section">
                            <h5 class="form-section-title">
                                <i class="fas fa-palette me-2"></i>Apparence et style
                            </h5>
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <label for="icon" class="form-label">
                                        <i class="fas fa-icons text-primary me-2"></i>Icône (classe CSS)
                                    </label>
                                    <div class="icon-input-group">
                                        <input 
                                            ...
                                            value="{{ old('icon', $typeProperty->icon ?? 'fas fa-building') }}" 
                                        />
                                        <span class="icon-preview" id="iconPreview">
                                            <i class="{{ old('icon', $typeProperty->icon ?? 'fas fa-building') }}"></i>
                                        </span>
                                    </div>
                                    <div class="form-text">
                                        Exemples: fas fa-home, fas fa-building, fas fa-warehouse
                                    </div>
                                    @error('icon')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                       ...
                                       <div class="d-flex align-items-center h-100">
                                        <div class="form-check form-switch form-check-lg">
                                            <input 
                                                ...
                                                name="is_active" 
                                               value="1"
                                                {{ old('is_active', $typeProperty->is_active ?? true) ? 'checked' : '' }} 
                                            />
                                            <label class="form-check-label" for="is_active">
                                                <i class="fas fa-toggle-on text-primary me-2"></i>
                                                <strong>Statut actif</strong>
                                                <div class="text-muted small">Le type de propriété sera visible et utilisable</div>
                                            </label>
                                        </div>
                                    </div>
                                    </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <button type="submit" class="btn app-btn-primary" id="submitBtn">
                                    <i class="fas fa-save me-2"></i>
                                    {{ $isEdit ? 'Mettre à jour' : 'Enregistrer' }} le type de propriété
                                </button>
                            </div>
                        </div>
                    </form>
